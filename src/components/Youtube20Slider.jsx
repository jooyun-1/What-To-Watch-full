...
export default function Youtube20Slider() {
  ...
  //   });
  // };
  const [top20Video, setTop20Video] = useState([]);

  const getTop20Videos = async () => {
    const APIURL = "http://localhost:3100/top20videos";
    // const params = {
    //   provider_name: provider,
    // };
    await axios.get(APIURL).then((response) => {
      setTop20Video(response.data.videoList);
    });
  };
